...
1. **회의 생산성 향상**: 수동 회의록 작성 시간 90% 절감
...
- **Fine-tuning**: Ttalkkak_model_v3.pt
- **분류**: Binary (업무/노이즈)
- **정확도**: 92.5%

### 3. Qwen3 (텍스트 생성)
- **Models**: 4B 버전
- **Fine-tuning**: LoRA 어댑터
