  ...
  return (
    <motion.div
      ...
      style={{
        ...style,
        borderLeftWidth: '4px',
        borderLeftColor: parentColor || '#3B82F6',
      ...
      className={`bg-white rounded-2xl p-4 shadow-soft border cursor-grab active:cursor-grabbing transition-all duration-200 hover:shadow-medium relative ${
